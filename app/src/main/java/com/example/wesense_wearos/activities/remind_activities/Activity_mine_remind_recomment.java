package com.example.wesense_wearos.activities.remind_activities;
...
import com.example.wesense_wearos.activities.mines_listitem.Activity_Task_Detail_Published;
...
import com.example.wesense_wearos.networkClasses.interfacesPack.PostRequest_mine_minor1_published;
import com.example.wesense_wearos.networkClasses.interfacesPack.PostRequest_remind_done;
import com.example.wesense_wearos.networkClasses.interfacesPack.PostRequest_remind_recommend;
...
public class Activity_mine_remind_recomment extends WearableActivity {
    private String TAG = "Activity_mine_remind_recomment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remind_recomment);
    ...
    private void initList() {
        mRecyclerView = findViewById(R.id.remind_recomment_RecyclerView);
        mSwipeRefreshLayout = findViewById(R.id.remind_recomment_swiperefreshLayout);
        ...
        recyclerAdapter.setRecyclerItemClickListener(new MCS_RecyclerItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Gson gson = new Gson();
                Intent intent = new Intent(Activity_mine_remind_recomment.this, Activity_Task_Detail_Published.class);
                ...
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        if (task_list.size() > 0) {
                            ...
                            Toast.makeText(Activity_mine_remind_recomment.this, getResources().getString(R.string.FailToGetData), Toast.LENGTH_SHORT).show();
                        }
                        ...
                        Toast.makeText(Activity_mine_remind_recomment.this, getResources().getString(R.string.Refresh) + tempList.size() + getResources().getString(R.string.Now) + mBean_ListView_remind.size() + getResources().getString(R.string.TaskNum), Toast.LENGTH_SHORT).show();
