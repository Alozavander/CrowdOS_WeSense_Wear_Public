...
public class Activity_mine_remind_done extends WearableActivity {
    private String TAG = "Activity_mine_remind_done";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remind_done);
    ...
    private void initList() {
        mRecyclerView = findViewById(R.id.remind_done_RecyclerView);
        mSwipeRefreshLayout = findViewById(R.id.remind_done_swiperefreshLayout);
        ...
        recyclerAdapter.setRecyclerItemClickListener(new MCS_RecyclerItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Gson gson = new Gson();
                Intent intent = new Intent(Activity_mine_remind_done.this, Activity_Task_Detail_Published.class);
                ...
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        if (task_list.size() > 0) {
                            ...
                            Toast.makeText(Activity_mine_remind_done.this, getResources().getString(R.string.FailToGetData), Toast.LENGTH_SHORT).show();
                        }
                        ...
                        Toast.makeText(Activity_mine_remind_done.this, getResources().getString(R.string.Refresh) + tempList.size() + getResources().getString(R.string.Now) + mBean_ListView_remind.size() + getResources().getString(R.string.TaskNum), Toast.LENGTH_SHORT).show();
